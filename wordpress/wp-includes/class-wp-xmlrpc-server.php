...
class wp_xmlrpc_server extends IXR_Server {
	...
	public function wp_getAuthors($args) {
		...
		$authors = array();
		foreach ( get_users_1( array( 'fields' => array('ID','user_login','display_name') ) ) as $user ) {
			$authors[] = array(
				'user_id'       => $user->ID,
	...
	public function wp_getComments($args) {
		...
		$comments = get_comments_1( array('status' => $status, 'post_id' => $post_id, 'offset' => $offset, 'number' => $number ) );
