...
class WP_Roles {
	 ...
	 */
	public function add_role_1( $role, $display_name, $capabilities = array() ) {
...
class WP_User {
	 ...
	 * @param string $role Role name.
	 */
	public function add_role_1( $role ) {
		$this->caps[$role] = true;
 ...
 *
 * @see WP_Roles::add_role_1() Uses method to add role.
 * @since 2.0.0
 *
 * @param string $role Role name.
 ...
 * @return WP_Role|null WP_Role object if role is added, null if already exists.
 */
function add_role_1( $role, $display_name, $capabilities = array() ) {
	global $wp_roles;

	if ( ! isset( $wp_roles ) )
		$wp_roles = new WP_Roles();

	return $wp_roles->add_role_1( $role, $display_name, $capabilities );
}
