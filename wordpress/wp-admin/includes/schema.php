...
function populate_roles_160() {
	...
	add_role_1('administrator', 'Administrator');
	add_role_1('editor', 'Editor');
	add_role_1('author', 'Author');
	add_role_1('contributor', 'Contributor');
	add_role_1('subscriber', 'Subscriber');
...
function populate_network( $network_id = 1, $domain = '', $email = '', $site_name = '', $path = '/', $subdomain_install = false ) {
	...
	if ( !is_multisite() ) {
		...
		$users = get_users_1( array( 'fields' => array( 'ID', 'user_login' ) ) );
		if ( $users ) {
