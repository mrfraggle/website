...
function wp_ajax_autocomplete_user() {
	...
	$include_blog_users = ( $type == 'search' ? get_users_1( array( 'blog_id' => $id, 'fields' => 'ID' ) ) : array() );
	$exclude_blog_users = ( $type == 'add' ? get_users_1( array( 'blog_id' => $id, 'fields' => 'ID' ) ) : array() );

	$users = get_users_1( array(
		'blog_id' => false,
